...
public class IconContainer : MonoBehaviour
{
    ...
    [SerializeField] private Sprite unknownActivityIcon; // NOUVEAU : Ic�ne "?" pour activites non decouvertes
    ...
    public void RefreshDisplay()
    {
        ...
        // NOUVEAU : Mettre a jour l'ic�ne en cas de decouverte
        UpdateIconDisplay();
    ...
    /// <summary>
    /// Obtenir l'ic�ne a afficher (normale ou "?" si pas decouverte)
    /// </summary>
    private Sprite GetDisplayIcon()
    {
        ...
        // Activite decouverte : afficher l'ic�ne normale
